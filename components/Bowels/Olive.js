...
const Olive = ({ loadNoir, loadIvory, loadOlive, loadRose }) => {
  ...
  const filteredProduct = products.filter((_, index) => index === 6);

  // Set ID to Stripe price
  const id = "price_1NKfbbFRHqR6fk4WvV3b6j0s";
  ...
  return (
    <div>
      <div className="flex lg:w-11/12 md:w-11/12 sm:w-11/12 lg:flex-row md:flex-col sm:flex-col mx-auto lg:mt-32 md:mt20 sm:mt-8 mb-40 lg:gap-12 md:gap-6 sm:gap-4">
                ...
                <div className="w-1/2 mx-auto lg:mt-8 md:mt-6 sm:mt-6 lg:hidden md:block sm:block">
                  ...
                  <div className="mt-4 mx-auto text-center">
                    <ul className="inline-flex">
                      ...
                      <li className="pl-6">
                        <button>
                          <span className="dot_olive outline outline-offset-2 outline-2 outline-neutral-500"></span>
                        </button>
                      </li>
                      <li className="pl-6">
